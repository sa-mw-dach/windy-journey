...
def process_image():
    ...
    if 'image' in data and 'time' in data:
        ...
        try:
            ...
            response.headers["Ce-Source"] = "wvi/eventing/image-processor"
            response.headers["Ce-Type"] = "wvi.image-processor.response"
            ...
            response.headers["Ce-specversion"] = "1.0"
            response.headers["Ce-Source"] = "wvi/eventing/image-processor"
            response.headers["Ce-Type"] = "wvi.image-processor.error"
...
if __name__ == '__main__':
    ...
    infer_url = os.getenv("INFER_URL", default="https://wvi-vi-onnx-ods-project-stefan.apps.ocp5.stormshift.coe.muc.redhat.com/v2/models/wvi-vi-onnx/infer")
